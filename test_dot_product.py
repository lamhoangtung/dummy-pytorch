...
dst_norm_trans_dst_pix = torch.load('dst_norm_trans_dst_pix.pt')
dst_pix_trans_src_pix = torch.load('dst_pix_trans_src_pix.pt')
src_pix_trans_src_norm = torch.load('src_pix_trans_src_norm.pt')
...
reference_result = torch.load('dst_norm_trans_src_norm.pt')
